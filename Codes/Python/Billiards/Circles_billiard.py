...
def Circles_billiard(p, v, n_col, center1, R1, center2, R2):
    point_list = [[p[0], p[1], 0]]
    for i in range(n_col):
        times = [circle_intersection(p, v, center1, R1, -PI, 2*PI, 1),
                 circle_intersection(p, v, center2, R2, -PI, 2*PI, -1)]
...
class Draw_single(Scene):
    def construct(self):
        ...
        render1 = Circles_billiard(p1, v1, num_col, center1, Radius1, center2, Radius2)
        self.add(b1)
        # print(render1)
        ...
        # render2 = Circles_billiard(p2, v2, num_col, center1, Radius1, center2, Radius2)
        # self.add(b2)
        # print(render2)
        ...
        # render3 = Circles_billiard(p3, v3, num_col, center1, Radius1, center2, Radius2)
        # self.add(b3)
        # print(render3)
        ...
        ###################################################
        " plotting boundary "
        self.add(Arc(Radius1, PI / 2, 2*PI, arc_center=np.dot(M,center1), stroke_width=boundary_width, color=boundary_color))
        self.add(Arc(Radius2, PI / 2, 2 * PI, arc_center=np.dot(M, center2), stroke_width=boundary_width,
...
class Draw_multiple(Scene):
    def construct(self):
        ...
        for l in range(Num_points):
            List.append(Circles_billiard(p_list[l], v_list[l], num_col, center1, Radius1, center2, Radius2))
